...
export default {
  name: "NewsDesktop",
  components: { Loader, TimeRouletteNew, BaseBreadcrumbs, BaseNewsCard, BaseButton, VPlayerMobile, ADmob, BaseTextBox },
  computed: {
